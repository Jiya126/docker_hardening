"""Hard task grader — scores Dockerfile patches for difficulty 3."""
...
class HardGrader(EasyGrader):
    """
    Hard-level grader.
    Heavier penalties for regressions, secrets, and false positives.
    Bonus for correctly NOT fixing unfixable CVEs.
    """
